...
```{r echo=FALSE, mn02, fig.cap='Performance of PADi models in “Kim2018” cohort with different numbers of SubModel. The x-axis is the number of SubModels, and the y-axis is the AUC of ROC analysis for ICI response prediction.', out.width='90%', fig.asp=.75, fig.align='center'}
