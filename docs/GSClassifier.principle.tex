...
\NormalTok{res\_pad }\OtherTok{\textless{}{-}} \FunctionTok{PAD}\NormalTok{(}
  ...
  \AttributeTok{subtype =} \StringTok{"PAD.train\_20200110"}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{PAD }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\FunctionTok{system.file}\NormalTok{(}\StringTok{"extdata"}\NormalTok{, }\StringTok{"PAD.train\_20200110.rds"}\NormalTok{, }\AttributeTok{package =} \StringTok{"GSClassifier"}\NormalTok{))}
