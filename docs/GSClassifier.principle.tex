...
The flowchart of \textbf{GSClassifier} is showed in Figure \ref{fig:flowchart}. 补充一些内容，说明一下图的框架。
...
\NormalTok{      vals2 }\OtherTok{\textless{}{-}}\NormalTok{ expr\_sub[}\FunctionTok{rownames}\NormalTok{(expr\_sub) }\SpecialCharTok{\%in\%}\NormalTok{ set2,i]}
      ...
      \CommentTok{\# Compare expression level of each gene in Set1 with all genes in Set2. }
