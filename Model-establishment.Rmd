...
```{r echo=FALSE, mn01, fig.cap='Performance of PADi models in “Kim2018” cohort with 200 different training seeds. Each row is the data of a seed. Each column is a sample from the “Kim2018” cohort.', out.width='90%', fig.asp=.75, fig.align='center'}
knitr::include_graphics(rep("./fig/model-no-01.png", 1))
```

```{r echo=FALSE, mn02, fig.cap='Performance of PADi models in “Kim2018” cohort with different numbers of SubModel. The x-axis is the number of SubModels, and the y-axis is the AUC of ROC analysis for ICI response prediction.', out.width='50%', fig.asp=.75, fig.align='center'}
knitr::include_graphics(rep("./fig/model-no-02.png", 1))
```
