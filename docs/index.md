...
You can label chapter and section titles using `{#label}` after them, e.g., we can reference Chapter \@ref(pre2). If you do not manually label them, there will be automatic labels anyway, e.g., Chapter \@ref(pre2).
...
{\centering \includegraphics[width=0.8\linewidth]{index_files/figure-latex/nice-fig-1} 
