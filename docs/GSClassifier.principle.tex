...
As show in Figure \ref{fig:tsp}, The TSP matrix consists of 3 parts: \textbf{binned expression matrix}, \textbf{top scoring of gene pairs}, and \textbf{gene set pairs}.
...
\caption{The components of TSP}\label{fig:tsp}
\end{figure}
...
\CommentTok{\#  0.51  0.52  0.53  0.21  0.22  0.23  0.10 }
\CommentTok{\# }
\CommentTok{\# Binned expression: }
\CommentTok{\# Gene1 Gene2 Gene3 Gene4 Gene5 Gene6 Gene7 }
\CommentTok{\#     3     4     4     1     2     2     1}
\end{Highlighting}
\end{Shaded}
